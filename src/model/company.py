...
class Company(Base):
    ...
    cin = Column(String(255), nullable=False, unique=True)
    ...
    company_age = Column(String(255), nullable=True)
    ...
    latest_revenue = Column(String(255), nullable=True)
    ...
    main_activity_group_code = Column(String(255), nullable=True)
    description_of_main_activity = Column(Text, nullable=True)
    business_activity_code = Column(String(255), nullable=True)
